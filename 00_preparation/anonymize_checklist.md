...
| 8 | Tên vai trò nội bộ | Khái quát hoá (Role A/B/C) | Có — Recruiter/Manager/Admin/Interviewer → Role A/B/C/D (bảng ánh xạ tại masking_glossary.md) |
| 9 | Tên người / email / SĐT | Xoá hoặc thay User A/B | Có — không nhúng bất kỳ tên người/username nào vào tài liệu |
| 10 | Tên các trường | TextboxA, comboboxB, linkuploadC | N/A — UC gốc không có tên biến nội bộ dạng code |
| 11 | Tên các button | ButtonA, ButtonB | N/A — UC gốc không có tên button custom dạng code |
| 12 | Nội dung label | Không cần liệt kê trong .md, tự viết trong test case | Đã tuân thủ — không liệt kê label chi tiết ngoài mô tả REF |
